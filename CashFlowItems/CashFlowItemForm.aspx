...
<div class="v4formContainer">
    <div class="marginL">
        ...
        <div class="predicate_block">
            ...
            <v4dbselect:DBSCashFlowType ID="tbCashFlowItemType" runat="server" Width="330px" IsRequired="True" IsAlwaysAdvancedSearch="False" AutoSetSingleValue="True" CSSClass="aligned_control" NextControl="tbCashFlowItemName"/>
        </div>
